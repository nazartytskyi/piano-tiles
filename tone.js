                      ...
                      if ((-1 !== s && (this._automationEvents = this._automationEvents.slice(0, s)), x(t))) {
                        ...
                        void 0 !== i && C(i) && this._automationEvents.push(u(this.getValue(e), e)),
                          void 0 !== i &&
                            ...
                            (this._automationEvents[this._automationEvents.length - 1] = l(
                  ...
                  value: function (t) {
                    ...
                    if (e > 1) {
                      var s = this._automationEvents.slice(e - 1),
                        n = s[0];
                      C(n) &&
                        s.unshift(u(v(this._automationEvents, e - 2, n.startTime, this._defaultValue), n.startTime)),
        ...
        if ('undefined' != typeof Symbol && Symbol.iterator in Object(t)) {
          ...
          try {
            for (
              ...
              !(n = (r = a.next()).done) && (s.push(r.value), !e || s.length !== e);
              n = !0
            );
          } catch (t) {
            (i = !0), (o = t);
    ...
    function (t, e, s) {
      ...
      const a = new WeakSet(),
        ...
        G = (t) =>
          void 0 === t ||
          'number' == typeof t ||
          ('string' == typeof t && ('balanced' === t || 'interactive' === t || 'playback' === t)),
        U = (t) => 'context' in t,
        Q = (t) => U(t[0]),
        Z = (t, e, s, n) => {
          for (const e of t)
      ...
      function ft(t, e, s, n, i) {
        if ('function' == typeof t.copyFromChannel)
          0 === e[s].byteLength && (e[s] = new Float32Array(128)), t.copyFromChannel(e[s], n, i);
        else {
      ...
      const _t = (t, e, s, n, i) => {
        ...
        Bt = (t, e) => {
          ...
          return (
            It(s, e), Nt(s, e, 'Q'), Nt(s, e, 'detune'), Nt(s, e, 'frequency'), Nt(s, e, 'gain'), Ft(s, e, 'type'), s
          );
        },
        Wt = (t, e) => {
        ...
        Gt = (t, e) => ((t.connect = e.connect.bind(e)), (t.disconnect = e.disconnect.bind(e)), t),
        Ut = (t, e) => {
      ...
      function Xt(t, e) {
        ...
        for (let o = t.length - 1; o >= 0; o -= 1)
          (i = e), (s = [(n = s)[0] * i[0] - n[1] * i[1], n[0] * i[1] + n[1] * i[0]]), (s[0] += t[o]);
        var n, i;
        return s;
      }
          ...
          (t, e) => {
            ...
            try {
              ...
              return s instanceof Promise
                ? (we.set(t, s), s.catch(() => !1).then((e) => (we.delete(t), be.set(t, e), e)))
                : (be.set(t, s), s);
            } catch {
              return be.set(t, !1), !1;
            }
          ...
          class {
            ...
            addEventListener(t, e, s) {
              if (null !== e) {
                ...
                void 0 === n && ((n = ze(this, e)), 'function' == typeof e && this._listeners.set(e, n)),
      ...
      const Ue = (
          (t) => (e) =>
            null !== t && 'function' == typeof t.AudioNode && e instanceof t.AudioNode
        )(Te),
        Qe = (
          (t) => (e) =>
            null !== t && 'function' == typeof t.AudioParam && e instanceof t.AudioParam
        )(Te),
        Ze = ((t, e, s, n, i, o, r, a, c, u, l, p, f, _, m) =>
                    ...
                    (t, n = 0, i = 0) => {
                      ...
                      return (
                        void 0 === r
                          ...
                          : r.every((t) => t.input !== i || t.output !== n) && r.push({ input: i, output: n }),
                        o
                      );
                    })),
                    (t.disconnect =
              ...
              if (void 0 === t)
                ...
                n = ((t, e, s) => {
                  ...
                  for (const o of n.outputs)
                    o[1] === s && (Q(o) ? ut(t, e, ...o) : lt(t, e, ...o), i.push(o[0]), n.outputs.delete(o));
                  return i;
                })(this, h, t);
              } else {
                if (void 0 !== e && (e < 0 || e >= this.numberOfOutputs)) throw i();
                if (U(t) && void 0 !== s && (s < 0 || s >= t.numberOfInputs)) throw i();
                if (
                  ((n = ((t, e, s, n, i) => {
                    const o = L(t);
          ...
          (t, e, s) => {
            ...
            Xe.set(t, { activeInputs: n, outputs: new Set(), passiveInputs: new WeakMap(), renderer: e });
          }),
          ((t, e, s, n, i, o, r, a, c, h, u, l, p) => (d, f, _, m, g) => {
            ...
            return (
              !!h(x, [f, _, m], (t) => t[0] === f && t[1] === _ && t[2] === m, !0) &&
              (w.add(b), u(d) ? t(v, d, [_, m, b], !0) : e(y, m, [d, _, b], !0), !0)
            );
      ...
      const Ye = ((t, e, s, n, i, o) =>
          class extends t {
            ...
            set maxDecibels(t) {
              ...
              if (((this._nativeAnalyserNode.maxDecibels = t), !(t > this._nativeAnalyserNode.minDecibels)))
            ...
            set minDecibels(t) {
              ...
              if (((this._nativeAnalyserNode.minDecibels = t), !(this._nativeAnalyserNode.maxDecibels > t)))
      ...
      const us = ((t, e) => (s, n, i, o) => (t(n).replay(i), e(n, s, i, o)))(
        ...
        ps = (
              ...
              w = {
                ...
                cancelAndHoldAtTime(t) {
                  if ('function' == typeof m.cancelAndHoldAtTime)
                    null === x && y.flush(f.context.currentTime), y.add(i(t)), m.cancelAndHoldAtTime(t);
                  else {
                    ...
                    m.cancelScheduledValues(t),
                      e !== s &&
                        ...
                        ('exponentialRampToValue' === s.type
                          ...
                          : 'setValueCurve' === s.type && m.setValueCurveAtTime(s.values, s.startTime, s.duration));
                  }
                  return w;
                },
                cancelScheduledValues: (t) => (
                  null === x && y.flush(f.context.currentTime), y.add(o(t)), m.cancelScheduledValues(t), w
                ),
                ...
                linearRampToValueAtTime: (t, e) => (
                  null === x && y.flush(f.context.currentTime), y.add(c(t, e)), m.linearRampToValueAtTime(t, e), w
                ),
                setTargetAtTime: (t, e, s) => (
                  null === x && y.flush(f.context.currentTime), y.add(h(t, e, s)), m.setTargetAtTime(t, e, s), w
                ),
                setValueAtTime: (t, e) => (
                  null === x && y.flush(f.context.currentTime), y.add(u(t, e)), m.setValueAtTime(t, e), w
                ),
                setValueCurveAtTime(t, e, s) {
                  ...
                  if (null !== p && 'webkitAudioContext' === p.name) {
                    ...
                    null === x && y.flush(f.context.currentTime), y.add(l(c, e, s)), m.setValueCurveAtTime(c, e, s);
                    const h = r / i;
                    h < t && d(w, c[c.length - 1], h), d(w, n[n.length - 1], t);
                  } else
                    null === x && y.flush(f.context.currentTime), y.add(l(n, e, s)), m.setValueCurveAtTime(n, e, s);
                  return w;
                },
              };
          ...
          ((ds = u),
          (t, e) => {
            ds.set(t, { activeInputs: new Set(), passiveInputs: new WeakMap(), renderer: e });
          }),
          je,
          l,
          (t) => ({
            ...
            start(t = 0, e = 0, s) {
              if (
                ...
                null !== this._audioBufferSourceNodeRenderer &&
                  (this._audioBufferSourceNodeRenderer.start = void 0 === s ? [t, e] : [t, e, s]),
        ...
        _s = ((t, e, s, n, i, o, r, a) =>
          ...
          ((t, e) => (s, n, i) => {
            ...
            i && 'explicit' !== o.channelCountMode && (o.channelCountMode = 'explicit'),
              0 === o.maxChannelCount && Object.defineProperty(o, 'maxChannelCount', { value: n });
            const r = t(s, {
              channelCount: n,
          ...
          return (
            (s.connect =
              ...
              (i, a = 0, c = 0) => {
                ...
                if (e(i))
                  return (
                    r.call(s, i, a, c), t(o, [i, a, c], (t) => t[0] === i && t[1] === a && t[2] === c, !0), h && n(), i
                  );
      ...
      const Es = ((t, e) => (s, n) => {
        ...
        Ls =
          ...
          (t, e) => {
            ...
            return (
              Nt(s, e, 'attack'), Nt(s, e, 'knee'), Nt(s, e, 'ratio'), Nt(s, e, 'release'), Nt(s, e, 'threshold'), s
            );
          });
      var zs;
      const Bs = ((t, e, s, n, i, o, r, a) =>
          class extends t {
            ...
            set channelCount(t) {
              ...
              if (((this._nativeDynamicsCompressorNode.channelCount = t), t > 2))
                throw ((this._nativeDynamicsCompressorNode.channelCount = e), i());
            }
            get channelCountMode() {
            ...
            set channelCountMode(t) {
              ...
              if (((this._nativeDynamicsCompressorNode.channelCountMode = t), 'max' === t))
                throw ((this._nativeDynamicsCompressorNode.channelCountMode = e), i());
            }
            get knee() {
              return this._knee;
            }
            ...
            get reduction() {
              return 'number' == typeof this._nativeDynamicsCompressorNode.reduction.value
        ...
        Gs = (
          (t, e, s, n) =>
          (i, o, { channelCount: r, channelCountMode: a, channelInterpretation: c, feedback: h, feedforward: u }) => {
                  ...
                  const c = e(r, {
                    ...
                    l = (e, n) => {
                      ...
                      return (
                        i.connect(c, 0, e),
                        i.start(),
                        Object.defineProperty(i.offset, 'defaultValue', { get: () => n }),
                ...
                return void 0 !== p
                  ...
                  : (async (h, u, l) => {
                      ...
                      return (
                        o.set(u, p),
                        d
                          ? (await t(u, h.detune, p.detune, l), await t(u, h.frequency, p.frequency, l))
                          : (await n(u, h.detune, p.detune, l), await n(u, h.frequency, p.frequency, l)),
                        await i(h, u, p, l),
                        p
                      );
                    })(h, u, l);
      ...
      const sn = (
        ...
        nn = ((t, e, s, n, i, o, r) => (a, c) => {
          ...
          r(
            ...
            (t) => () => t.call(h),
            (e) => (s) => (
              e.call(h, s), p && (n(s) && null === l ? (l = t(a, h)) : n(s) || null === l || (l(), (l = null))), s
            )
          );
          return i(
            h,
      ...
      const cn = ((t, e, s, n, i, o, r) =>
          ...
          ((t, e, s, n, i, o) => {
            ...
            return (e, { channelCount: n, channelCountMode: r, pan: a, ...c }) => {
              ...
              const _ = {
                ...
                set channelCount(t) {
                  l.channelCount !== t &&
                    (m && f(), ({ connectGraph: d, disconnectGraph: f } = u(e, t, l, p, h)), m && d()),
                    (l.channelCount = t);
                },
                get channelCountMode() {
                      ...
                      c = new Blob(
                        [
                          `${n};(registerProcessor=>{${o}\n})((n,p)=>registerProcessor(n,class extends p{${
                            s ? '' : '__c = (a) => a.forEach(e=>this.__b.add(e.buffer));'
                          }process(i,o,p){${
                            s ? '' : 'i.forEach(this.__c);o.forEach(this.__c);this.__c(Object.values(p));'
          ...
          class extends f {
            constructor(e, s) {
              super(e, s),
                ...
                (this._audioWorklet = void 0 === t ? void 0 : { addModule: (e, s) => t(this, e, s) });
            }
            get audioWorklet() {
        ...
        Tn = ((t, e, s, n) =>
          ...
          (t, e) => {
            ...
            return (
              It(s, e), 1 === s.numberOfOutputs && Object.defineProperty(s, 'numberOfOutputs', { get: () => 0 }), s
            );
          },
          Fe,
          Ne
        ...
        Vn = ((t, e, s, n, i, o, r, a, c, h, u, l, p) => (d, f, _, g) => {
            ...
            (...t) => {
              if ('message' === t[0]) {
                const e =
                  'function' == typeof t[1]
                    ? t[1]
                    : 'object' == typeof t[1] && null !== t[1] && 'function' == typeof t[1].handleEvent
                    ? t[1].handleEvent
                    : null;
                if (null !== e) {
                  const s = P.get(t[1]);
          ...
          const W = mt(g.numberOfInputs, g.channelCount),
            ...
            U =
              void 0 === _.parameterDescriptors
                ? []
                : _.parameterDescriptors.reduce((t, { name: e }) => ({ ...t, [e]: new Float32Array(128) }), {});
          let Q = !0;
          const Z = () => {
              ...
              for (let n = 0; n < A; n += 128) {
                ...
                try {
                  const t = W.map((t, e) => {
                      ...
                      return void 0 === n
                        ? []
                        : (t.every((t) => t.every((t) => 0 === t)) && (1 === n ? X.delete(e) : X.set(e, n - 1)), t);
                    }),
                    ...
                    if ('processorerror' === t[0]) {
                      ...
                      if (null !== e) {
                        ...
                        void 0 !== s
                          ...
                          : ((t[1] = (s) => {
                              'error' === s.type
                                ? (Object.defineProperties(s, { type: { value: 'processorerror' } }), e(s))
        ...
        Wn = ((t, e, s, n, i, o, r, a) => {
          ...
          return (h, u) =>
            s(h)
              ...
              .then(() => i(u))
              .then(
                (s) => ('function' != typeof s.copyFromChannel ? (r(s), F(s)) : e(o, () => o(s)) || a(s), t.add(s), s)
              );
      ...
      function si(t) {
        t.isOffline ||
          'running' === t.state ||
          ri('The AudioContext is "suspended". Invoke Tone.start() from a user action to start the audio.');
      }
      let ni = console;
      function ii(t) {
        ni = t;
      ...
      class Ni extends Ei {
        ...
        add(t) {
          if (
            (ti(Reflect.has(t, 'time'), 'Timeline: events must have a time attribute'),
          ...
          if (this._timeline.length > 1) {
            ...
            if (e >= 0)
              if (Ii(this._timeline[e].time, t)) {
                for (let s = e; s >= 0 && Ii(this._timeline[s].time, t); s--) e = s;
                this._timeline = this._timeline.slice(0, e);
              } else this._timeline = this._timeline.slice(0, e + 1);
            else this._timeline = [];
          } else 1 === this._timeline.length && qi(this._timeline[0].time, t) && (this._timeline = []);
          return this;
        }
        cancelBefore(t) {
      ...
      class Bi extends Ei {
        ...
        off(t, e) {
          return (
            t.split(/\W+/).forEach((s) => {
              if ((ai(this._events) && (this._events = {}), this._events.hasOwnProperty(t)))
      ...
      class Gi extends Wi {
        ...
        initialize() {
          var t;
          return this._initialized || ((t = this), Pi.forEach((e) => e(t)), (this._initialized = !0)), this;
        }
        createAnalyser() {
        ...
        set listener(t) {
          ti(!this._initialized, 'The listener cannot be set after initialization.'), (this._listener = t);
        }
        get transport() {
          return this.initialize(), this._transport;
        }
        set transport(t) {
          ti(!this._initialized, 'The transport cannot be set after initialization.'), (this._transport = t);
        }
        get draw() {
          return this.initialize(), this._draw;
        }
        set draw(t) {
          ti(!this._initialized, 'Draw cannot be set after initialization.'), (this._draw = t);
        }
        get destination() {
          return this.initialize(), this._destination;
        }
        set destination(t) {
          ti(!this._initialized, 'The destination cannot be set after initialization.'), (this._destination = t);
        }
        createAudioWorkletNode(t, e) {
          return (function (t, e, s) {
            return ti(ci(zn), 'This node only works in a secure context (https or localhost)'), new zn(t, e, s);
          })(
            /*! *****************************************************************************
...
***************************************************************************** */ this.rawContext,
      ...
      function Ui(t, e) {
        di(e) ? e.forEach((e) => Ui(t, e)) : Object.defineProperty(t, e, { enumerable: !0, writable: !1 });
      }
      function Qi(t, e) {
        di(e) ? e.forEach((e) => Qi(t, e)) : Object.defineProperty(t, e, { writable: !0 });
      }
      const Zi = () => {};
      class Xi extends Ei {
        constructor() {
        ...
        constructor() {
          ...
          super({
            ...
            context: Ti(arguments[0])
              ? arguments[0]
              : ((t = arguments[0]), (e = arguments[1] * arguments[2]), (s = arguments[2]), new Gn(t, e, s)),
            lookAhead: 0,
      ...
      class yo extends Ni {
        ...
        setStateAtTime(t, e, s) {
          return ei(e, 0), this.add(Object.assign({}, s, { state: t, time: e })), this;
        }
        getLastState(t, e) {
      ...
      class xo extends vo {
        constructor() {
          ...
          (this._swappable = !!ci(t.swappable) && t.swappable),
            this._swappable
              ? ((this.input = this.context.createGain()), (this._param = t.param), this.input.connect(this._param))
        ...
        static getDefaults() {
          return Object.assign(vo.getDefaults(), { convert: !0, units: 'number' });
        }
        get value() {
          const t = this.now();
        ...
        _assertRange(t) {
          return (
            ci(this.maxValue) &&
              ci(this.minValue) &&
              ei(t, this._fromType(this.minValue), this._fromType(this.maxValue)),
            t
          );
        }
        _fromType(t) {
        ...
        linearRampTo(t, e, s) {
          return (
            (s = this.toSeconds(s)), this.setRampPoint(s), this.linearRampToValueAtTime(t, s + this.toSeconds(e)), this
          );
        }
        targetRampTo(t, e, s) {
        ...
        cancelScheduledValues(t) {
          ...
          return (
            ti(isFinite(e), 'Invalid argument to cancelScheduledValues: ' + JSON.stringify(t)),
        ...
        rampTo(t, e = 0.1, s) {
          return (
            'frequency' === this.units || 'bpm' === this.units || 'decibels' === this.units
      ...
      class wo extends vo {
        ...
        dispose() {
          return (
            super.dispose(),
            ci(this.input) &&
              (this.input instanceof wo ? this.input.dispose() : bi(this.input) && this.input.disconnect()),
            ci(this.output) &&
              (this.output instanceof wo ? this.output.dispose() : bi(this.output) && this.output.disconnect()),
      ...
      function bo(...t) {
        const e = t.shift();
        t.reduce((t, e) => (t instanceof wo ? t.connect(e) : bi(t) && To(t, e), e), e);
      }
      function To(t, e, s = 0, n = 0) {
        for (
          ti(ci(t), 'Cannot connect from undefined node'),
            ...
            ti(t.numberOfOutputs > 0, 'Cannot connect from node with no outputs');
      ...
      class ko extends wo {
        ...
        static getDefaults() {
          return Object.assign(wo.getDefaults(), { convert: !0, gain: 1, units: 'gain' });
        }
        dispose() {
        ...
        constructor(t) {
          super(t),
            ...
            (this.getStateAtTime = function (t) {
              const e = this.toSeconds(t);
              return -1 !== this._startTime && e >= this._startTime && (-1 === this._stopTime || e <= this._stopTime)
                ? 'started'
                : 'stopped';
            }),
      ...
      class Ao extends Co {
        ...
        static getDefaults() {
          return Object.assign(Co.getDefaults(), { convert: !0, offset: 1, units: 'number' });
        }
        start(t) {
          const e = this.toSeconds(t);
      ...
      class Do extends wo {
        constructor() {
          super(Di(Do.getDefaults(), arguments, ['value', 'units'])), (this.name = 'Signal'), (this.override = !0);
        ...
        static getDefaults() {
          return Object.assign(wo.getDefaults(), { convert: !0, units: 'number', value: 0 });
        }
        connect(t, e = 0, s = 0) {
      ...
      function Oo(t, e, s, n) {
        (e instanceof xo || wi(e) || (e instanceof Do && e.override)) &&
          (e.cancelScheduledValues(0), e.setValueAtTime(0, 0), e instanceof Do && (e.overridden = !0)),
          To(t, e, s, n);
      }
      class Mo extends xo {
        constructor() {
          ...
          (this._multiplier = t.multiplier),
            ...
            this._events.add({ ticks: 0, time: 0, type: 'setValueAtTime', value: this._fromType(t.value) }),
      ...
      class Ro extends vo {
        constructor() {
          ...
          (this.frequency = new Eo({ context: this.context, units: t.units, value: t.frequency })),
            Ui(this, 'frequency'),
        ...
        start(t, e) {
          ...
          return (
            'started' !== this._state.getValueAtTime(s) &&
              (this._state.setStateAtTime('started', s), ci(e) && this.setTicksAtTime(e, s)),
            this
          );
        }
        stop(t) {
          ...
          return (
            this._state.forEachBetween(s.time, e + this.sampleTime, (t) => {
              ...
              s && s.time >= i.time && ((o = s.ticks), (e = s.time)),
                'started' === i.state &&
                  'started' !== t.state &&
                  (o += this.frequency.getTicksAtTime(t.time) - this.frequency.getTicksAtTime(e)),
                (i = t);
            }),
        ...
        setTicksAtTime(t, e) {
          return (
            ...
            this._tickOffset.add({ seconds: this.frequency.getDurationOfTicks(t, e), ticks: t, time: e }),
            this
          );
        }
        getStateAtTime(t) {
        ...
        forEachTickBetween(t, e, s) {
          ...
          this._state.forEachBetween(t, e, (e) => {
            n &&
              'started' === n.state &&
              'started' !== e.state &&
              this.forEachTickBetween(Math.max(n.time, t), e.time - this.sampleTime, s),
              (n = e);
          });
          let i = null;
      ...
      class qo extends vo {
        constructor() {
          ...
          (this.callback = t.callback),
            (this._tickSource = new Ro({ context: this.context, frequency: t.frequency, units: t.units })),
            (this._lastUpdate = 0),
      ...
      class Vo extends Ei {
        ...
        get(t) {
          return ti(this.has(t), 'ToneAudioBuffers has no buffer named: ' + t), this._buffers.get(t.toString());
        }
        _bufferLoaded(t) {
      ...
      class Bo extends Ei {
        ...
        add(t) {
          ...
          for (null === this._root ? (this._root = e) : this._root.insert(e), this._length++; null !== e; )
        ...
        _replaceNodeInParent(t, e) {
          null !== t.parent
            ? (t.isLeftChild() ? (t.parent.left = e) : (t.parent.right = e), this._rebalance(t.parent))
            : this._setRoot(e);
        }
        _removeNode(t) {
        ...
        dispose() {
          return (
            super.dispose(), null !== this._root && this._root.traverse((t) => t.dispose()), (this._root = null), this
          );
        }
      }
      class Wo {
      ...
      class Go extends wo {
        constructor() {
          ...
          (this.input = this.output = new ko({ context: this.context, gain: t.volume, units: 'decibels' })),
      ...
      class Uo extends wo {
        ...
        chain(...t) {
          return this.input.disconnect(), t.unshift(this.input), t.push(this.output), bo(...t), this;
        }
        get maxChannelCount() {
      ...
      class Qo extends Ei {
        constructor(t) {
          super(), (this.name = 'TimelineValue'), (this._timeline = new Ni({ memory: 10 })), (this._initialValue = t);
        }
        set(t, e) {
      ...
      class Xo extends Zo {
        ...
        static getDefaults() {
          return Object.assign({}, Zo.getDefaults(), { duration: 1 / 0, interval: 1, once: !1 });
        }
        invoke(t) {
      ...
      class Yo extends vo {
        ...
        schedule(t, e) {
          const s = new Zo(this, { callback: t, time: new mo(this.context, e).toTicks() });
        ...
        scheduleOnce(t, e) {
          const s = new Zo(this, { callback: t, once: !0, time: new mo(this.context, e).toTicks() });
          return this._addEvent(s, this._timeline);
        }
        clear(t) {
        ...
        toggle(t) {
          return (
            (t = this.toSeconds(t)), 'started' !== this._clock.getStateAtTime(t) ? this.start(t) : this.stop(t), this
          );
        }
        get timeSignature() {
      ...
      class Ho extends wo {
        constructor(t) {
          super(t),
            ...
            (this._volume = this.output = new Go({ context: this.context, mute: t.mute, volume: t.volume })),
            (this.volume = this._volume.volume),
            Ui(this, 'volume'),
            (this.onstop = t.onstop);
        }
        static getDefaults() {
          return Object.assign(wo.getDefaults(), { mute: !1, onstop: Zi, volume: 0 });
        }
        get state() {
          return this._synced
        ...
        start(t, e, s) {
          ...
          if (((n = this._clampToCurrentTime(n)), this._synced || 'started' !== this._state.getValueAtTime(n)))
            if ((this.log('start', n), this._state.setStateAtTime('started', n), this._synced)) {
              ...
              t && ((t.offset = this.toSeconds(Oi(e, 0))), (t.duration = s ? this.toSeconds(s) : void 0));
              const i = this.context.transport.schedule((t) => {
                this._start(t, e, s);
              }, n);
              this._scheduled.push(i),
                'started' === this.context.transport.state &&
                  this.context.transport.getSecondsAtTime(this.immediate()) > n &&
        ...
        dispose() {
          return (
            super.dispose(), (this.onstop = Zi), this.unsync(), this._volume.dispose(), this._state.dispose(), this
          );
        }
      }
      class $o extends Co {
        ...
        start(t, e, s, n = 1) {
          ...
          if (this.loop) {
            const t = this.toSeconds(this.loopEnd) || this.buffer.duration,
              ...
              s = t - e;
            qi(o, t) && (o = ((o - e) % s) + e), Ii(o, this.buffer.duration) && (o = 0);
          }
          if (
            ((this._source.buffer = this.buffer.get()),
            (this._source.loopEnd = this.toSeconds(this.loopEnd) || this.buffer.duration),
            Fi(o, this.buffer.duration) && ((this._sourceStarted = !0), this._source.start(i, o)),
            ci(s))
          ) {
      ...
      class Jo extends Ho {
        ...
        set type(t) {
          if (
            (ti(t in tr, 'Noise: invalid type: ' + t), this._type !== t && ((this._type = t), 'started' === this.state))
          ) {
            const t = this.now();
      ...
      class er extends wo {
        constructor() {
          ...
          (this._volume = this.output = new Go({ context: this.context, volume: t.volume })),
            (this.volume = this._volume.volume),
            Ui(this, 'volume'),
            (this.mute = t.mute);
        }
        ...
        open(t) {
          return yi(this, void 0, void 0, function* () {
            ...
            ui(t)
              ? (this._device = e[t])
              : ((this._device = e.find((e) => e.label === t || e.deviceId === t)),
      ...
      function sr(t, e) {
        return yi(this, void 0, void 0, function* () {
          ...
          new t.constructor(Object.assign(t.get(), { frequency: 2 / s, detune: 0, context: n }))
            .toDestination()
            .start(0);
      ...
      class ir extends Ho {
        constructor() {
          ...
          (this.frequency = new Do({ context: this.context, units: 'frequency', value: t.frequency })),
            Ui(this, 'frequency'),
            (this.detune = new Do({ context: this.context, units: 'cents', value: t.detune })),
            Ui(this, 'detune'),
        ...
        _start(t) {
          const e = this.toSeconds(t),
            s = new nr({ context: this.context, onended: () => this.onstop(this) });
          (this._oscillator = s),
        ...
        _getCachedPeriodicWave() {
          if ('custom' === this._type) {
            return ir._periodicWaveCache.find((t) => {
              return (
                t.phase === this._phase &&
                ((e = t.partials), (s = this._partials), e.length === s.length && e.every((t, e) => s[e] === t))
              );
              var e, s;
            });
          }
        ...
        set type(t) {
          ...
          if (0 === this._phase && e)
            (this._wave = void 0), (this._partialCount = 0), null !== this._oscillator && (this._oscillator.type = t);
          else {
      ...
      class ar extends or {
        constructor() {
          super(...arguments),
            ...
            (this._norm = new rr({ context: this.context, mapping: (t) => (t + 1) / 2 })),
      ...
      class cr extends Do {
        constructor() {
          ...
          (this._mult =
            this.input =
            this.output =
              new ko({ context: this.context, minValue: t.minValue, maxValue: t.maxValue })),
      ...
      class hr extends Ho {
        constructor() {
          ...
          (this._carrier = new ir({
            ...
            (this._modulator = new ir({ context: this.context, phase: t.phase, type: t.modulationType })),
            (this.harmonicity = new cr({ context: this.context, units: 'positive', value: t.harmonicity })),
      ...
      class ur extends Ho {
        constructor() {
          ...
          (this._carrier = new ir({
            ...
            (this._modulator = new ir({ context: this.context, phase: t.phase, type: t.modulationType })),
            (this.harmonicity = new cr({ context: this.context, units: 'positive', value: t.harmonicity })),
            (this.modulationIndex = new cr({ context: this.context, units: 'positive', value: t.modulationIndex })),
      ...
      class lr extends Ho {
        constructor() {
          super(Di(lr.getDefaults(), arguments, ['frequency', 'width'])),
            ...
            (this._thresh = new rr({ context: this.context, mapping: (t) => (t <= 0 ? -1 : 1) }));
          const t = Di(lr.getDefaults(), arguments, ['frequency', 'width']);
          (this.width = new Do({ context: this.context, units: 'audioRange', value: t.width })),
      ...
      class pr extends Ho {
        ...
        dispose() {
          return (
            super.dispose(), this.frequency.dispose(), this.detune.dispose(), this._forEach((t) => t.dispose()), this
          );
        }
      }
      class dr extends Ho {
        constructor() {
          ...
          (this._pulse = new lr({ context: this.context, frequency: t.modulationFrequency })),
      ...
      class _r extends Ho {
        ...
        get type() {
          let t = '';
          return (
            ['am', 'fm', 'fat'].some((t) => this._sourceType === t) && (t = this._sourceType), t + this._oscillator.type
          );
        }
        set type(t) {
          'fm' === t.substr(0, 2)
        ...
        get modulationType() {
          return this._getOscType(this._oscillator, 'fm') || this._getOscType(this._oscillator, 'am')
      ...
      class gr extends or {
        constructor() {
          ...
          (this._mult = this.input = new cr({ context: this.context, value: t.max - t.min })),
            (this._add = this.output = new mr({ context: this.context, value: t.min })),
            (this._min = t.min),
            (this._max = t.max),
      ...
      class yr extends wo {
        constructor() {
          ...
          (this._oscillator = new ir(t)),
            ...
            (this._amplitudeGain = new ko({ context: this.context, gain: t.amplitude, units: 'normalRange' })),
            (this.amplitude = this._amplitudeGain.gain),
            (this._stoppedSignal = new Do({ context: this.context, units: 'audioRange', value: 0 })),
            (this._zeros = new vr({ context: this.context })),
            (this._a2g = new ar({ context: this.context })),
            (this._scaler = this.output = new gr({ context: this.context, max: t.max, min: t.min })),
            (this.units = t.units),
            (this.min = t.min),
            (this.max = t.max),
        ...
        connect(t, e, s) {
          return (
            (t instanceof xo || t instanceof Do) && ((this.convert = t.convert), (this.units = t.units)),
            Oo(this, t, e, s),
            this
          );
        }
      ...
      class br extends Ho {
        ...
        _start(t, e, s) {
          ...
          this._loop ||
            this._synced ||
            (this._state.cancel(t + o), this._state.setStateAtTime('stopped', t + o, { implicitEnd: !0 })),
      ...
      class Tr extends wo {
        constructor() {
          ...
          (this._volume = this.output = new Go({ context: this.context, volume: t.volume })),
            (this.volume = this._volume.volume),
            Ui(this, 'volume'),
            (this._buffers = new Vo({ urls: t.urls, onload: t.onload, baseUrl: t.baseUrl, onerror: t.onerror })),
            (this.mute = t.mute),
            (this._fadeIn = t.fadeIn),
            (this._fadeOut = t.fadeOut);
        }
        ...
        player(t) {
          if ((ti(this.has(t), `No Player with the name ${t} exists on this object`), !this._players.has(t))) {
            const e = new br({
              context: this.context,
              fadeIn: this._fadeIn,
              fadeOut: this._fadeOut,
        ...
        add(t, e, s) {
          return (
            ti(!this._buffers.has(t), 'A buffer with that name already exists on this object'),
      ...
      class Sr extends Ho {
        constructor() {
          ...
          (this.buffer = new Xi({ onload: t.onload, onerror: t.onerror, reverse: t.reverse, url: t.url })),
            (this._clock = new qo({
              context: this.context,
        ...
        set playbackRate(t) {
          ei(t, 0.001), (this._playbackRate = t), (this.grainSize = this._grainSize);
        }
        get loopStart() {
          return this._loopStart;
        }
        set loopStart(t) {
          this.buffer.loaded && ei(this.toSeconds(t), 0, this.buffer.duration), (this._loopStart = this.toSeconds(t));
        }
        get loopEnd() {
          return this._loopEnd;
        }
        set loopEnd(t) {
          this.buffer.loaded && ei(this.toSeconds(t), 0, this.buffer.duration), (this._loopEnd = this.toSeconds(t));
        }
        get reverse() {
      ...
      class kr extends or {
        constructor() {
          super(...arguments),
            (this.name = 'Abs'),
            (this._abs = new rr({ context: this.context, mapping: (t) => (Math.abs(t) < 0.001 ? 0 : Math.abs(t)) })),
      ...
      class Cr extends or {
        constructor() {
          super(...arguments),
            ...
            (this._norm = new rr({ context: this.context, mapping: (t) => 2 * Math.abs(t) - 1 })),
            (this.input = this._norm),
            (this.output = this._norm);
        }
        dispose() {
        ...
        constructor() {
          super(Object.assign(Di(Or.getDefaults(), arguments))),
            ...
            (this._thresh = this.output =
              new rr({ context: this.context, length: 127, mapping: (t) => (t <= 0 ? 0 : 1) })),
            (this._scale = this.input = new cr({ context: this.context, value: 1e4 })),
      ...
      class Mr extends Do {
        constructor() {
          ...
          (this._subtract = this.input = new Dr({ context: this.context, value: t.value })),
      ...
      class Er extends or {
        constructor() {
          ...
          (this._exponentScaler =
            this.input =
            this.output =
              new rr({ context: this.context, mapping: this._expFunc(t.value), length: 8192 })),
      ...
      class Rr extends gr {
        constructor() {
          ...
          (this.input = this._exp = new Er({ context: this.context, value: t.exponent })),
        ...
        constructor() {
          ...
          (this._lastVal = t.value),
            ...
            (this._constantSource = this.output =
              new Ao({ context: this.context, offset: t.value, units: t.units }).start(0)),
            this.setValueAtTime(t.value, 0);
        }
        _onTick(t) {
      ...
      class Fr extends wo {
        ...
        _setCurve(t, e, s) {
          if (fi(s) && Reflect.has(Ir, s)) {
            ...
            if (!di(s) || '_decayCurve' === t) throw new Error('Envelope: invalid curve: ' + s);
            this[t] = s;
          }
        }
        get attackCurve() {
        ...
        triggerRelease(t) {
          ...
          if (e > 0) {
            ...
            s < this.sampleTime
              ...
              : (ti(di(this._releaseCurve), "releaseCurve must be either 'linear', 'exponential' or an array"),
                this._sig.cancelAndHoldAtTime(t),
      ...
      class Vr extends wo {
        ...
        sync() {
          return (
            this._syncState() && (this._syncMethod('triggerAttack', 1), this._syncMethod('triggerRelease', 0)), this
          );
        }
        _syncState() {
          let t = !1;
      ...
      class jr extends Nr {
        constructor() {
          ...
          (this.oscillator = new _r(
            Object.assign({ context: this.context, detune: t.detune, onstop: () => this.onsilence(this) }, t.oscillator)
          )),
            (this.frequency = this.oscillator.frequency),
            (this.detune = this.oscillator.detune),
            (this.envelope = new Pr(Object.assign({ context: this.context }, t.envelope))),
      ...
      class Lr extends Nr {
        constructor() {
          ...
          (this._carrier = new jr({
            ...
            (this.frequency = new Do({ context: this.context, units: 'frequency' })),
            (this.detune = new Do({ context: this.context, value: t.detune, units: 'cents' })),
            (this.harmonicity = new cr({ context: this.context, value: t.harmonicity, minValue: 0 })),
            (this._modulationNode = new ko({ context: this.context, gain: 0 })),
            Ui(this, [
              'frequency',
              'harmonicity',
      ...
      class Br extends wo {
        constructor() {
          ...
          (this._filter = this.context.createBiquadFilter()),
            ...
            (this.Q = new xo({ context: this.context, units: 'number', value: t.Q, param: this._filter.Q })),
            (this.frequency = new xo({
              context: this.context,
              units: 'frequency',
              value: t.frequency,
      ...
      class Wr extends wo {
        constructor() {
          ...
          (this._filters = []),
            (this.Q = new Do({ context: this.context, units: 'positive', value: t.Q })),
            (this.frequency = new Do({ context: this.context, units: 'frequency', value: t.frequency })),
            (this.detune = new Do({ context: this.context, units: 'cents', value: t.detune })),
            (this.gain = new Do({ context: this.context, units: 'decibels', convert: !1, value: t.gain })),
            (this._type = t.type),
      ...
      class Gr extends Fr {
        constructor() {
          ...
          (this._octaves = t.octaves),
            ...
            (this._exponent = this.input = new Er({ context: this.context, value: t.exponent })),
      ...
      class Ur extends Nr {
        constructor() {
          ...
          (this.oscillator = new _r(
            Object.assign(t.oscillator, { context: this.context, detune: t.detune, onstop: () => this.onsilence(this) })
          )),
            (this.frequency = this.oscillator.frequency),
            (this.detune = this.oscillator.detune),
            (this.filter = new Wr(Object.assign(t.filter, { context: this.context }))),
            (this.filterEnvelope = new Gr(Object.assign(t.filterEnvelope, { context: this.context }))),
            (this.envelope = new Pr(Object.assign(t.envelope, { context: this.context }))),
        ...
        static getDefaults() {
          return Object.assign(Nr.getDefaults(), {
            ...
            oscillator: Object.assign(Mi(_r.getDefaults(), Object.keys(Ho.getDefaults())), { type: 'sawtooth' }),
          });
        }
      ...
      class Qr extends Nr {
        constructor() {
          ...
          (this.voice0 = new Ur(
            Object.assign(t.voice0, { context: this.context, onsilence: () => this.onsilence(this) })
          )),
            (this.voice1 = new Ur(Object.assign(t.voice1, { context: this.context }))),
            (this.harmonicity = new cr({ context: this.context, units: 'positive', value: t.harmonicity })),
            (this._vibrato = new yr({ frequency: t.vibratoRate, context: this.context, min: -50, max: 50 })),
            this._vibrato.start(),
            (this.vibratoRate = this._vibrato.frequency),
            (this._vibratoGain = new ko({ context: this.context, units: 'normalRange', gain: t.vibratoAmount })),
            (this.vibratoAmount = this._vibratoGain.gain),
            (this.frequency = new Do({ context: this.context, units: 'frequency', value: 440 })),
            (this.detune = new Do({ context: this.context, units: 'cents', value: t.detune })),
        ...
        getLevelAtTime(t) {
          return (
            (t = this.toSeconds(t)), this.voice0.envelope.getValueAtTime(t) + this.voice1.envelope.getValueAtTime(t)
          );
        }
        static getDefaults() {
      ...
      class Zr extends Lr {
        constructor() {
          ...
          (this.modulationIndex = new cr({ context: this.context, value: t.modulationIndex })),
            this.frequency.connect(this._carrier.frequency),
            this.frequency.chain(this.harmonicity, this._modulator.frequency),
            this.frequency.chain(this.modulationIndex, this._modulationNode),
            this.detune.fan(this._carrier.detune, this._modulator.detune),
      ...
      class Yr extends Nr {
        constructor() {
          ...
          (this.detune = new Do({ context: this.context, units: 'cents', value: t.detune })),
            (this.frequency = new Do({ context: this.context, units: 'frequency' })),
            (this._amplitude = new ko({ context: this.context, gain: 0 }).connect(this.output)),
            (this._highpass = new Wr({ Q: 0, context: this.context, type: 'highpass' }).connect(this._amplitude));
          ...
          (this._filterFreqScaler = new gr({ context: this.context, max: 7e3, min: this.toFrequency(t.resonance) })),
      ...
      class $r extends Vr {
        constructor() {
          ...
          (this.noise = new Jo(Object.assign({ context: this.context }, t.noise))),
            (this.envelope = new Pr(Object.assign({ context: this.context }, t.envelope))),
            this.noise.chain(this.envelope, this.output);
        }
        static getDefaults() {
          return Object.assign(Vr.getDefaults(), {
            envelope: Object.assign(Mi(Fr.getDefaults(), Object.keys(wo.getDefaults())), { decay: 0.1, sustain: 0 }),
            noise: Object.assign(Mi(Jo.getDefaults(), Object.keys(Ho.getDefaults())), { type: 'white' }),
          });
        }
        triggerAttack(t, e = 1) {
          return (
            ...
            this.noise.start(t),
            0 === this.envelope.sustain &&
              this.noise.stop(t + this.toSeconds(this.envelope.attack) + this.toSeconds(this.envelope.decay)),
            this
          );
        }
        triggerRelease(t) {
        ...
        sync() {
          return (
            this._syncState() && (this._syncMethod('triggerAttack', 0), this._syncMethod('triggerRelease', 0)), this
          );
        }
        triggerAttackRelease(t, e, s = 1) {
          return (
            (e = this.toSeconds(e)), (t = this.toSeconds(t)), this.triggerAttack(e, s), this.triggerRelease(e + t), this
          );
        }
        dispose() {
        ...
        constructor(t) {
          ...
          (this._dummyGain = this.context.createGain()),
            ...
            this.context.addAudioWorkletModule(e, s).then(() => {
              this.disposed ||
                ((this._worklet = this.context.createAudioWorkletNode(s, this.workletOptions)),
      ...
      class ia extends wo {
        constructor() {
          ...
          (this._combFilter = this.output =
            new sa({ context: this.context, delayTime: t.delayTime, resonance: t.resonance })),
            (this.delayTime = this._combFilter.delayTime),
            (this.resonance = this._combFilter.resonance),
            (this._lowpass = this.input = new na({ context: this.context, frequency: t.dampening, type: 'lowpass' })),
      ...
      class oa extends Vr {
        constructor() {
          ...
          (this._noise = new Jo({ context: this.context, type: 'pink' })),
            ...
            (this._lfcf = new ia({ context: this.context, dampening: t.dampening, resonance: t.resonance })),
      ...
      class ra extends Vr {
        ...
        _getNextAvailableVoice() {
          ...
          if (this._voices.length < this.maxPolyphony) {
            const t = new this.voice(
              Object.assign(this.options, { context: this.context, onsilence: this._makeVoiceAvailable.bind(this) })
            );
        ...
        triggerAttackRelease(t, e, s, n) {
          ...
          if ((this.triggerAttack(t, i, n), di(e))) {
            ti(di(t), 'If the duration is an array, the notes must also be an array'), (t = t);
            for (let s = 0; s < t.length; s++) {
              const n = e[Math.min(s, e.length - 1)],
                o = this.toSeconds(n);
              ti(o > 0, 'The duration must be greater than 0'), this.triggerRelease(t[s], i + o);
            }
          } else {
            const s = this.toSeconds(e);
            ti(s > 0, 'The duration must be greater than 0'), this.triggerRelease(t, i + s);
          }
          return this;
        }
        sync() {
          return (
            this._syncState() && (this._syncMethod('triggerAttack', 1), this._syncMethod('triggerRelease', 1)), this
          );
        }
        set(t) {
          const e = Mi(t, ['onsilence', 'context']);
          return (
            (this.options = Ai(this.options, e)), this._voices.forEach((t) => t.set(e)), this._dummyVoice.set(e), this
          );
        }
        get() {
      ...
      class aa extends Vr {
        constructor() {
          ...
          Object.keys(t.urls).forEach((s) => {
            ...
            if ((ti(_i(s) || (ui(n) && isFinite(n)), 'url key is neither a note or midi pitch: ' + s), _i(s))) {
              const n = new lo(this.context, s).toMidi();
              e[n] = t.urls[s];
            } else ui(n) && isFinite(n) && (e[n] = t.urls[n]);
          }),
            (this._buffers = new Vo({ urls: e, onload: t.onload, baseUrl: t.baseUrl, onerror: t.onerror })),
            (this.attack = t.attack),
            (this.release = t.release),
            (this.curve = t.curve),
        ...
        add(t, e, s) {
          if ((ti(_i(t) || isFinite(t), 'note must be a pitch or midi: ' + t), _i(t))) {
      ...
      class ca extends vo {
            ...
            if ('started' === t.state) {
              ...
              if (!0 === this._loop || (ui(this._loop) && this._loop > 1)) {
                ...
                null !== n && (e = Math.min(e, n.time - s)),
                  e !== 1 / 0 &&
                    (this._state.setStateAtTime('stopped', s + e + 1, { id: -1 }), (e = new jo(this.context, e)));
              ...
              } else t.id = this.context.transport.schedule(this._tick.bind(this), new jo(this.context, s));
            }
          });
        }
        get state() {
        ...
        start(t) {
          ...
          return (
            'stopped' === this._state.getValueAtTime(e) &&
              (this._state.add({ id: -1, state: 'started', time: e }), this._rescheduleEvents(e)),
            this
          );
        }
        stop(t) {
        ...
        _tick(t) {
          ...
          if (!this.mute && 'started' === this._state.getValueAtTime(e)) {
            ...
            if (this.humanize) {
              let e = 0.02;
              pi(this.humanize) || (e = this.toSeconds(this.humanize)), (t += (2 * Math.random() - 1) * e);
            }
      ...
      class ua extends ca {
          ...
          (e -= s),
            this._loop
              ? t.startOffset >= this._loopStart && t.startOffset < this._loopEnd
                ? (t.startOffset < s && (e += this._getLoopDuration()), t.start(new jo(this.context, e)))
        ...
        at(t, e) {
          ...
          for (; !o.done; ) {
            const t = o.value;
            if (Math.abs(s - t.startOffset) < n) return ci(e) && (t.value = e), t;
            o = i.next();
          }
        ...
        add(t, e) {
          ...
          return (
            e instanceof ca
              ...
              : (n = new ca({ callback: this._tick.bind(this), context: this.context, value: e })),
            (n.startOffset = s),
            n.set({
        ...
        remove(t, e) {
          return (
            ...
            this._events.forEach((s) => {
              s.startOffset === t && (ai(e) || (ci(e) && s.value === e)) && (this._events.delete(s), s.dispose());
            }),
            this
          );
        }
        ...
        _testLoopBoundries(t) {
          this._loop && (t.startOffset < this._loopStart || t.startOffset >= this._loopEnd)
            ? t.cancel(0)
      ...
      function* _a(t, e) {
        ...
        for (;;) (s = fa(s, t)), yield t[s], e ? (s++, s >= t.length - 1 && (e = !1)) : (s--, s <= 0 && (e = !0));
      }
      function* ma(t) {
        let e = 0,
          s = 0;
        for (; e < t.length; ) (e = fa(e, t)), yield t[e], s++, (e += s % 2 ? 2 : -1);
      }
      function* ga(t) {
        let e = t.length - 1,
          s = 0;
      ...
      function* ya(t, e = 'up', s = 0) {
        switch ((ti(t.length > 0, 'The array must have more than one value in it'), e)) {
          case 'up':
            yield* da(t, la);
          case 'down':
            yield* da(t, pa);
      ...
      class wa extends ca {
        constructor() {
          super(Di(wa.getDefaults(), arguments, ['callback', 'events', 'subdivision'])),
            (this.name = 'Sequence'),
            (this._part = new ua({ callback: this._seqCallback.bind(this), context: this.context })),
            (this._events = []),
            (this._eventsArray = []);
        ...
        _createSequence(t) {
          return new Proxy(t, {
            get: (t, e) => t[e],
            set: (t, e, s) => (
              fi(e) && isFinite(parseInt(e, 10)) && di(s) ? (t[e] = this._createSequence(s)) : (t[e] = s),
              this._eventsUpdated(),
              !0
            ),
          });
      ...
      class ba extends wo {
        constructor() {
          ...
          (this.fade = new Do({ context: this.context, units: 'normalRange', value: t.fade })),
            Ui(this, 'fade'),
      ...
      class Sa extends Ta {
        constructor(t) {
          super(t),
            (this.name = 'LFOEffect'),
            (this._lfo = new yr({ context: this.context, frequency: t.frequency, amplitude: t.depth })),
      ...
      class Aa extends Sa {
        constructor() {
          ...
          (this._panner = new Ca({ context: this.context, channelCount: t.channelCount })),
        ...
        constructor() {
          ...
          (this._abs = this.input = new kr({ context: this.context })),
            (this._lowpass = this.output =
              new na({ context: this.context, frequency: 1 / this.toSeconds(t.smoothing), type: 'lowpass' })),
      ...
      class Oa extends Ta {
        constructor() {
          ...
          (this._follower = new Da({ context: this.context, smoothing: t.follower })),
            (this._sweepRange = new Rr({ context: this.context, min: 0, max: 1, exponent: 0.5 })),
            (this._baseFrequency = this.toFrequency(t.baseFrequency)),
            (this._octaves = t.octaves),
            (this._inputBoost = new ko({ context: this.context })),
            (this._bandpass = new Wr({ context: this.context, rolloff: -48, frequency: 0, Q: t.Q })),
            (this._peaking = new Wr({ context: this.context, type: 'peaking' })),
      ...
      class Ma extends Ta {
        constructor() {
          ...
          (this._bitCrusherWorklet = new Ea({ context: this.context, bits: t.bits })),
          ...
          return (
            s.has(e) ||
              (0 === e
                ...
                : 1 === e
                ? s.set(e, t)
                : s.set(e, 2 * t * this._getCoefficient(t, e - 1, s) - this._getCoefficient(t, e - 2, s))),
            s.get(e)
          );
        }
        get order() {
      ...
      class Ia extends wo {
        constructor(t) {
          super(t),
            ...
            (this._dryWet = this.output = new ba({ context: this.context, fade: t.wet })),
            (this.wet = this._dryWet.fade),
        ...
        connectEffectLeft(...t) {
          this._split.connect(t[0], 0, 0), bo(...t), To(t[t.length - 1], this._merge, 0, 0);
        }
        connectEffectRight(...t) {
          this._split.connect(t[0], 1, 0), bo(...t), To(t[t.length - 1], this._merge, 0, 1);
        }
        static getDefaults() {
          return Object.assign(wo.getDefaults(), { wet: 1 });
        }
      ...
      class Va extends Ia {
        constructor(t) {
          super(t),
            (this.feedback = new Do({ context: this.context, value: t.feedback, units: 'normalRange' })),
            (this._feedbackL = new ko({ context: this.context })),
            (this._feedbackR = new ko({ context: this.context })),
            (this._feedbackSplit = new qa({ context: this.context, channels: 2 })),
            (this._feedbackMerge = new Fa({ context: this.context, channels: 2 })),
      ...
      class Na extends Va {
        constructor() {
          ...
          (this._depth = t.depth),
            ...
            (this._lfoL = new yr({ context: this.context, frequency: t.frequency, min: 0, max: 1 })),
            (this._lfoR = new yr({ context: this.context, frequency: t.frequency, min: 0, max: 1, phase: 180 })),
      ...
      class ja extends Ta {
        constructor(t) {
          super(t),
            ...
            (this._feedbackGain = new ko({ context: this.context, gain: t.feedback, units: 'normalRange' })),
      ...
      class La extends ja {
        constructor() {
          ...
          (this._delayNode = new Fo({ context: this.context, delayTime: t.delayTime, maxDelay: t.maxDelay })),
      ...
      class Ba extends Ta {
        constructor() {
          ...
          (this.frequency = new Do({
            ...
            (this._cosine = new ir({ context: this.context, phase: -90, type: 'sine' })),
      ...
      class Ua extends Ia {
        constructor() {
          ...
          (this.roomSize = new Do({ context: this.context, value: t.roomSize, units: 'normalRange' })),
            ...
            (this._combFilters = Wa.map((e, s) => {
              const n = new ia({ context: this.context, dampening: t.dampening, delayTime: e });
              return (
                s < Wa.length / 2
      ...
      class Ya extends Ia {
        constructor() {
          ...
          (this.roomSize = new Do({ context: this.context, value: t.roomSize, units: 'normalRange' })),
            (this._scaleRoomSize = new gr({ context: this.context, min: -0.733, max: 0.197 })),
      ...
      class $a extends Ha {
        constructor() {
          ...
          (this._leftDelay = new Fo({ context: this.context, maxDelay: t.maxDelay })),
            (this._rightDelay = new Fo({ context: this.context, maxDelay: t.maxDelay })),
            (this._rightPreDelay = new Fo({ context: this.context, maxDelay: t.maxDelay })),
            (this.delayTime = new Do({ context: this.context, units: 'time', value: t.delayTime })),
      ...
      class Ja extends ja {
        constructor() {
          ...
          (this._frequency = new Do({ context: this.context })),
            ...
            (this._lfoA = new yr({ context: this.context, min: 0, max: 0.1, type: 'sawtooth' }).connect(
              this._delayA.delayTime
            )),
            (this._delayB = new Fo({ maxDelay: 1, context: this.context })),
            (this._lfoB = new yr({ context: this.context, min: 0, max: 0.1, type: 'sawtooth', phase: 180 }).connect(
              this._delayB.delayTime
            )),
            ...
            (this._feedbackDelay = new Fo({ delayTime: t.delayTime, context: this.context })),
      ...
      class Ka extends Ia {
        constructor() {
          ...
          (this._lfoL = new yr({ context: this.context, frequency: t.frequency, min: 0, max: 1 })),
            ...
            (this._baseFrequency = this.toFrequency(t.baseFrequency)),
            (this._octaves = t.octaves),
            (this.Q = new Do({ context: this.context, value: t.Q, units: 'positive' })),
      ...
      class tc extends Ta {
        ...
        set decay(t) {
          ei((t = this.toSeconds(t)), 0.001), (this._decay = t), this.generate();
        }
        get preDelay() {
      ...
      class ec extends wo {
        constructor() {
          super(Di(ec.getDefaults(), arguments)),
            ...
            (this._split = this.input = new qa({ channels: 2, context: this.context })),
            ...
            (this.side = new cr({ context: this.context, value: Math.SQRT1_2 })),
      ...
      class sc extends wo {
        constructor() {
          super(Di(sc.getDefaults(), arguments)),
            ...
            (this._leftMult = new cr({ context: this.context, value: Math.SQRT1_2 })),
            (this._right = new Dr({ context: this.context })),
            (this._rightMult = new cr({ context: this.context, value: Math.SQRT1_2 })),
      ...
      class ic extends nc {
        constructor() {
          ...
          (this.width = new Do({ context: this.context, value: t.width, units: 'normalRange' })),
            Ui(this, ['width']),
            (this._twoTimesWidthMid = new cr({ context: this.context, value: 2 })),
            (this._twoTimesWidthSide = new cr({ context: this.context, value: 2 })),
      ...
      class oc extends Ia {
        constructor() {
          ...
          (this._lfoL = new yr({ context: this.context, type: t.type, min: 1, max: 0 })),
            (this._lfoR = new yr({ context: this.context, type: t.type, min: 1, max: 0 })),
            (this._amplitudeL = new ko({ context: this.context })),
            (this._amplitudeR = new ko({ context: this.context })),
            (this.frequency = new Do({ context: this.context, value: t.frequency, units: 'frequency' })),
            (this.depth = new Do({ context: this.context, value: t.depth, units: 'normalRange' })),
            Ui(this, ['frequency', 'depth']),
      ...
      class rc extends Ta {
        constructor() {
          ...
          (this._delayNode = new Fo({ context: this.context, delayTime: 0, maxDelay: t.maxDelay })),
            (this._lfo = new yr({
              context: this.context,
              type: t.type,
              min: 0,
        ...
        static getDefaults() {
          return Object.assign(Ta.getDefaults(), { maxDelay: 0.005, frequency: 5, depth: 0.1, type: 'sine' });
        }
        get type() {
          return this._lfo.type;
        }
      ...
      class ac extends wo {
        constructor() {
          ...
          (this.input = this.output = this._gain = new ko({ context: this.context })),
            (this._split = new qa({ context: this.context, channels: t.channels })),
            this.input.connect(this._split),
            ei(t.channels, 1);
        ...
        set type(t) {
          ti('waveform' === t || 'fft' === t, 'Analyser: invalid type: ' + t), (this._type = t);
        }
        get smoothing() {
      ...
      class hc extends cc {
        constructor() {
          ...
          (this.input =
            this.output =
            this._analyser =
              new ac({ context: this.context, size: 256, type: 'waveform', channels: t.channels })),
            (this.smoothing = t.smoothing),
            (this.normalRange = t.normalRange);
        }
        static getDefaults() {
          return Object.assign(cc.getDefaults(), { smoothing: 0.8, normalRange: !1, channels: 1 });
        }
        getLevel() {
        ...
        getValue() {
          const t = this._analyser.getValue(),
            e = (1 === this.channels ? [t] : t).map((t) => {
              ...
              return (
                (this._rms = Math.max(s, this._rms * this.smoothing)), this.normalRange ? this._rms : so(this._rms)
              );
            });
      ...
      class uc extends cc {
        ...
        static getDefaults() {
          return Object.assign(wo.getDefaults(), { normalRange: !1, size: 1024, smoothing: 0.8 });
        }
        getValue() {
        ...
        getFrequencyOfIndex(t) {
          return (
            ti(0 <= t && t < this.size, 'index must be greater than or equal to 0 and less than ' + this.size),
      ...
      class dc extends wo {
        ...
        set solo(t) {
          t ? this._addSolo() : this._removeSolo(), dc._allSolos.get(this.context).forEach((t) => t._updateSolo());
        }
        get muted() {
        ...
        _noSolos() {
          return (
            !dc._soloed.has(this.context) || (dc._soloed.has(this.context) && 0 === dc._soloed.get(this.context).size)
          );
        }
        _updateSolo() {
      ...
      class fc extends wo {
        constructor() {
          ...
          (this._panner = this.input = new Ca({ context: this.context, pan: t.pan, channelCount: t.channelCount })),
        ...
        static getDefaults() {
          return Object.assign(wo.getDefaults(), { mute: !1, pan: 0, volume: 0, channelCount: 1 });
        }
        get mute() {
          return this._volume.mute;
        }
      ...
      class _c extends wo {
        constructor() {
          ...
          (this._solo = this.input = new dc({ solo: t.solo, context: this.context })),
        ...
        static getDefaults() {
          return Object.assign(wo.getDefaults(), { pan: 0, volume: 0, mute: !1, solo: !1, channelCount: 1 });
        }
        get solo() {
        ...
        _getBus(t) {
          return _c.buses.has(t) || _c.buses.set(t, new ko({ context: this.context })), _c.buses.get(t);
        }
        send(t, e = 0) {
      ...
      class mc extends wo {
        constructor() {
          super(Di(mc.getDefaults(), arguments)),
            (this.name = 'Mono'),
            (this.input = new ko({ context: this.context })),
            (this._merge = this.output = new Fa({ channels: 2, context: this.context })),
      ...
      class gc extends wo {
        constructor() {
          super(Di(gc.getDefaults(), arguments, ['lowFrequency', 'highFrequency'])),
            ...
            (this.input = new ko({ context: this.context })),
            (this.output = void 0),
            (this.low = new Wr({ context: this.context, frequency: 0, type: 'lowpass' })),
            (this._lowMidFilter = new Wr({ context: this.context, frequency: 0, type: 'highpass' })),
            (this.mid = new Wr({ context: this.context, frequency: 0, type: 'lowpass' })),
            (this.high = new Wr({ context: this.context, frequency: 0, type: 'highpass' })),
            (this._internalChannels = [this.low, this.mid, this.high]);
          const t = Di(gc.getDefaults(), arguments, ['lowFrequency', 'highFrequency']);
          (this.lowFrequency = new Do({ context: this.context, units: 'frequency', value: t.lowFrequency })),
            (this.highFrequency = new Do({ context: this.context, units: 'frequency', value: t.highFrequency })),
            (this.Q = new Do({ context: this.context, units: 'positive', value: t.Q })),
      ...
      class vc extends wo {
        constructor() {
          super(...arguments),
            (this.name = 'Listener'),
            (this.positionX = new xo({ context: this.context, param: this.context.rawContext.listener.positionX })),
            (this.positionY = new xo({ context: this.context, param: this.context.rawContext.listener.positionY })),
            (this.positionZ = new xo({ context: this.context, param: this.context.rawContext.listener.positionZ })),
            (this.forwardX = new xo({ context: this.context, param: this.context.rawContext.listener.forwardX })),
            (this.forwardY = new xo({ context: this.context, param: this.context.rawContext.listener.forwardY })),
            (this.forwardZ = new xo({ context: this.context, param: this.context.rawContext.listener.forwardZ })),
            (this.upX = new xo({ context: this.context, param: this.context.rawContext.listener.upX })),
            (this.upY = new xo({ context: this.context, param: this.context.rawContext.listener.upY })),
            (this.upZ = new xo({ context: this.context, param: this.context.rawContext.listener.upZ }));
        }
        static getDefaults() {
          return Object.assign(wo.getDefaults(), {
            positionX: 0,
      ...
      class yc extends wo {
        constructor() {
          ...
          (this._panner = this.input = this.output = this.context.createPanner()),
            ...
            (this.positionX = new xo({ context: this.context, param: this._panner.positionX, value: t.positionX })),
            (this.positionY = new xo({ context: this.context, param: this._panner.positionY, value: t.positionY })),
            (this.positionZ = new xo({ context: this.context, param: this._panner.positionZ, value: t.positionZ })),
      ...
      class wc extends wo {
        ...
        static getDefaults() {
          return Object.assign(wo.getDefaults(), { attack: 0.003, knee: 30, ratio: 12, release: 0.25, threshold: -24 });
        }
        get reduction() {
      ...
      class bc extends wo {
        constructor() {
          ...
          (this._follower = new Da({ context: this.context, smoothing: t.smoothing })),
            (this._gt = new Mr({ context: this.context, value: eo(t.threshold) })),
            (this.input = new ko({ context: this.context })),
      ...
      class Tc extends wo {
        constructor() {
          ...
          (this._compressor =
            this.input =
            this.output =
              new wc({ context: this.context, ratio: 20, attack: 0.003, release: 0.01, threshold: t.threshold })),
      ...
      class Sc extends wo {
        constructor() {
          ...
          (this._midSideSplit = this.input = new ec({ context: this.context })),
            (this._midSideMerge = this.output = new sc({ context: this.context })),
            (this.mid = new wc(Object.assign(t.mid, { context: this.context }))),
            (this.side = new wc(Object.assign(t.side, { context: this.context }))),
      ...
      class kc extends wo {
        constructor() {
          ...
          (this._splitter = this.input =
            new gc({ context: this.context, lowFrequency: t.lowFrequency, highFrequency: t.highFrequency })),
            (this.lowFrequency = this._splitter.lowFrequency),
            (this.highFrequency = this._splitter.highFrequency),
            (this.output = new ko({ context: this.context })),
            (this.low = new wc(Object.assign(t.low, { context: this.context }))),
            (this.mid = new wc(Object.assign(t.mid, { context: this.context }))),
            (this.high = new wc(Object.assign(t.high, { context: this.context }))),
      ...
      class Cc extends wo {
        constructor() {
          ...
          (this.input = this._multibandSplit =
            new gc({ context: this.context, highFrequency: t.highFrequency, lowFrequency: t.lowFrequency })),
            (this._lowGain = new ko({ context: this.context, gain: t.low, units: 'decibels' })),
            (this._midGain = new ko({ context: this.context, gain: t.mid, units: 'decibels' })),
            (this._highGain = new ko({ context: this.context, gain: t.high, units: 'decibels' })),
